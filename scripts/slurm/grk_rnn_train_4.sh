...
python greek_rnn/main.py -tr --masking smart --masking-strategy dynamic -ev

mkdir -p greek_rnn/log
mv greek_rnn/log/"$(ls -t greek_rnn/log | head -n 1)" log/strat_experiments/smart_dynam_"$(ls -t greek_rnn/log | head -n 1)"
mv greek_rnn/models/"$(ls -t greek_rnn/models | head -n 1)" greek_rnn/models/smart_dynam_"$(ls -t greek_rnn/models | head -n 1)"
