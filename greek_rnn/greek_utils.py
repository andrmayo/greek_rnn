...
# This module contains the model hyperparameters as well as various functions
# for data processing and logging information about the model
...
share = False
# share = True  # share embedding table with output layer for weight tying,
# cf. Jurafsky and Martin 9.2.3
...
class DataItem:
	def __init__(
		...
		# integer marking location of DataItem in original set of texts
		# (including non-Greek texts)
		self.position_in_original = position_in_original
